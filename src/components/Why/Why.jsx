        ...
        <div className="why">
            ...
            <div className="why-content">
                <div className="why-content-column">
                    ...
                    <div className="element">
                        <svg width="51" height="47" xmlns="http://www.w3.org/2000/svg"><g fill-rule="nonzero" fill="none"><path d="M.475 31.679c-2.588-9.235 5.81-20.825 15.39-26.8C25.444-1.142 36.158-1.55 43.013 3.43c6.81 4.935 9.715 15.256 6.946 24.672-2.724 9.416-11.168 17.972-22.2 18.832C16.727 47.75 3.108 40.868.475 31.68Z" fill="#FFC96A"></path><path d="M29.782 18.46a1.25 1.25 0 0 1 2.017 1.47l-.08.11-7.75 9.5a1.25 1.25 0 0 1-1.934.005l-.082-.112-3.75-5.75a1.25 1.25 0 0 1 2.014-1.476l.08.11 2.815 4.317 6.67-8.174Z" fill="#131415"></path></g></svg>
